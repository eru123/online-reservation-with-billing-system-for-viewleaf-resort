    ...
    return (
        <Container maxWidth="lg" sx={{padding:"6em 0 7em"}}>
            ...
            {active === 4?<>
                ...
                <Typography variant="body1" color="initial" fontWeight={400} mb={"20px"}>You can follow the instruction bellow for payment</Typography>
                <Payment/>
            </>:""}
            ...
            <Paper variant="elevation" elevation={3} sx={{position:"fixed",bottom:"0",left:"0",right:"0",padding:" 0 0 1em ",alignItems:"center"}}>
                {active === 5?"":<Box sx={{ width: '100%' }}>
                    <LinearProgress variant="determinate" value={active===1?0:0 || active===2?33:0 ||active===3?66:0 || active===4?100:0} />
                </Box>}
                ...
                <Container maxWidth="lg"sx={{display:"flex",alignItems:"center",marginTop:"1em"}}>
                    ...
                    <div style={{display:"flex",gap:"10px"}}>
                        ...
                        {active===4?<Button variant="contained" color="primary" href='Invoice'>
                            Finish
                        </Button>:<Button variant="contained" color="primary" onClick={()=> {if(active<4){setActive(active+1)}}}>
                            Next
                        </Button>}
                    </div>
                </Container> 
