        ...
        <Container maxWidth="lg" sx={{padding:"6em 0 7em"}}>
          ...
          <Box display="flex" gap={4} mt={2}>
            <Box >
              ...
              <Typography variant="h6" color="initial" fontWeight={600}>₱{reservation?.[0]?.invoices?.[0]?.total}</Typography>
            </Box>
            <Box >
              <Typography variant="subtitle2" color="initial" sx={{opacity:'.6'}}>Min. Payment</Typography>
              <Typography variant="h6" color="initial" fontWeight={600}>₱{reservation?.[0]?.invoices?.[0]?.minimum}</Typography>
            </Box>
          </Box>
