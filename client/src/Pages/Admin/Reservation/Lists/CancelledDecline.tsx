...
function CancelledDecline() {
  ...
  return (
    <div>
      <Typography variant="h4" fontWeight={600} color="primary">Cancelled and Declined List</Typography>
      <Typography variant="h6" fontWeight={400} color="initial" sx={{marginBottom:"2em"}}>Here are all the list of cancelled and declined list</Typography>
...
export default CancelledDecline